	...
	public static void main(String[] args) {
		...
		try {
            ...
            try {
                ...
                System.out.println("Número de nodos no-hoja: " + nonLeafNodesCount);
            } catch (ExceptionIsEmpty e) {
                System.out.println(e.getMessage());
            }
            System.out.println("La altura del árbol es: " + tree.height());
            System.out.println("El área del árbol es: " + tree.areaBST());

            System.out.println("Nodos del árbol: " + tree.contarNodosEnArbol());
