...
import laboratorio06.StackLink;
...
public class BSTree<E extends Comparable<E>> {
	...
	// Método público para iniciar el proceso recursivo de contar nodos en todo el árbol
    ...
    private int contarNodosRecursivoEnArbol(Node nodo) {
        ...
        // Contar el nodo actual y realizar llamadas recursivas para los subárboles izquierdo y derecho
